...
import { FaUsersCog } from 'react-icons/fa'; // Example Icon for Marketing and Communication

const CustomerAndSalesPage: React.FC = () => {
  ...
  return (
    <div style={{ padding: '20px', display: 'flex', justifyContent: 'center', backgroundColor: '#ffd069', borderRadius: '8px', border: '1px solid #ffba24' }}>
      <div className="w-full max-w-8xl p-12 bg-white shadow-md rounded-lg border border-[#ffba24]">
        {/* Icon on top of heading */}
        <div className="text-center mb-6">
          <FaUsersCog size={40} color="#d97706" />
        </div>

        <h2 className="text-4xl font-bold text-center mb-4 text-amber-600">Customer & Sales</h2>

        <p className="text-center mb-10 text-gray-600">Explore dynamic opportunities and strategies in customer relations and sales fields.</p>
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-7">
            ...
            <input
              ...
              className="mt-1 p-2 w-full border rounded bg-white hover:border-amber-500 focus:border-amber-500 transition-colors"
              required
            />
          </div>
          <div className="mb-7">
          ...
          <div className="mb-4 grid grid-cols-2 gap-4">
            ...
            <div className="col-span-1">
              ...
              <input
                ...
                className="mt-1 p-2 w-3/4 border rounded bg-white hover:border-amber-500 focus:border-amber-500 transition-colors"
                required
              />
            </div>
            <div className="col-span-1">
            ...
            <div>
              <div className="mb-7">
                ...
                >
                  ...
                  <option value="Intern">Customer and Sales Intern</option>
          ...
          <div className="mt-6">
            <button type="submit" className="px-4 py-2 bg-amber-600 text-white rounded-full hover:bg-amber-800 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:ring-opacity-50">
              Submit Application
            </button>
          </div>
        </form>
...
export default CustomerAndSalesPage;