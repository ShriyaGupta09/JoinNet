...
import { HiDatabase } from 'react-icons/hi'; // Example Icon for Data & Analytics
...
const DataAndAnalyticsPage: React.FC = () => {
  ...
  return (
    <div style={{ padding: '20px', display: 'flex', justifyContent: 'center', backgroundColor: '#c3c3ff', borderRadius: '8px', border: '1px solid #d3d3d6' }}>
      <div className="w-full max-w-8xl p-12 bg-white shadow-md rounded-lg border border-[#c3c3ff]">
        <div className="text-center mb-6">
          <HiDatabase size={40} color="#6a1b9a" />
        </div>

        <h2 className="text-4xl font-bold text-center mb-4 text-purple-800">Data & Analytics</h2>
        <p className="text-center mb-10 text-gray-800">Explore or apply for exciting opportunities in data and analytics fields.</p>
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-7">
            ...
            <input
              ...
              className="mt-1 p-2 w-full border rounded bg-white hover:border-purple-500 focus:border-purple-500 transition-colors"
              required
            />
          </div>
          <div className="mb-7">
          ...
          <div className="mb-4 grid grid-cols-2 gap-4">
            ...
            <div className="col-span-1">
              ...
              <input
                ...
                className="mt-1 p-2 w-3/4 border rounded bg-white hover:border-purple-500 focus:border-purple-500 transition-colors"
                required
              />
            </div>
            <div className="col-span-1">
  ...
  <div>
    ...
    />
          ...
          <div className="mt-6">
            <button type="submit" className="px-4 py-2 bg-purple-800 text-white rounded-full hover:bg-purple-900 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-opacity-50">
              Submit Application
            </button>
          </div>
        </form>
